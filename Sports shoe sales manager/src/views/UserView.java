...
public class UserView {
    ...
    public void addUser() {
        do {
            try {
                ...
                User user = new User(id, username, password, fullName, phone, email, address, Role.USER, createAt);
                setRole(user);
    ...
    public void userLogin(Role role) {
